...
import br.com.dbc.walletlife.manipulacaoDinheiro.GerenciadorFinancas;
import br.com.dbc.walletlife.manipulacaoDinheiro.PlanejamentoFinanceiroPessoal;
...
import br.com.dbc.walletlife.utils.AbstractFormatoEmail;
import br.com.dbc.walletlife.utils.AbstractValidarData;
                                ...
                                case 1:
                                    ...
                                    switch (escolhasManipulacao[0]) {
                                        case 1:
                                            ...
                                            do {
                                                ...
                                                if (tipoDespesa > 0 && tipoDespesa < 3) {
                                                    switch (tipoDespesa) {
                                                        case 1:
                                                            gerenciadorFinancas.addDespesa(new Despesa(TipoDespesaEReceita.FIXA, valor, descricao, data, usuario.getIdUsuario()));
                                                            break;
                                                        case 2:
                                                            gerenciadorFinancas.addDespesa(new Despesa(TipoDespesaEReceita.VARIAVEL, valor, descricao, data, usuario.getIdUsuario()));
                                                    }
                                        ...
                                        case 2:
                                            ...
                                            Investimento investimento = new Investimento(valor, descricao, corretora, dataInicio, usuario.getIdUsuario());
                                        ...
                                        case 3:
                                            ...
                                            gerenciadorFinancas.addReceita(new Receita(valor, descricao, banco, empresa, usuario.getIdUsuario()));
                                            break;
                                    }
                                    break;
                                case 2:
