...
public class DespesaDAO extends PersistenciaDAO implements CrudDAO<Integer, Despesa> {
...
//            e.printStackTrace();
	...
	public List<Despesa> listarReceitaPeloUsuario(Usuario usuario) throws BancoDeDadosException {
		List<Despesa> despesas;
		EntityManager con = null;
		try {
			con = this.getEntityManager();

			String sql = "Select u From Despesa u where (:usuario is null or u.usuarioFK = :usuario)";
