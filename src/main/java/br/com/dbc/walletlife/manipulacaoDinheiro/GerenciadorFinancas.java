...
//import br.com.dbc.walletlife.modelos.*;
...
//        Integer idUsuario = usuario.getIdFKUsuario();
//        int id = 0;
...
//        this.despesaService.editarDespesa(despesa.getIdFK(), despesa);
//    }
//
...
//
//        if (removido)
//            despesaService.removerDespesa(despesas.get(id).getIdFK());
//
//        return removido;
//    }
//
...
//        this.investimentoService.editarInvestimento(investimento.getIdFK(), investimento);
//    }
//
...
//        this.investimentos.replace(id, investimento);
//        investimentoService.editarInvestimento(investimento.getIdFK(), investimento);
//    }
//
...
//        if (removido)
//            this.investimentoService.removerInvestimento(investimento.getIdFK());
//        return removido;
//    }
//
...
//        this.receitaService.editarReceita(receita.getIdFK(), receita);
//    }
//
...
//
//        if (removido)
//            receitaService.removerReceita(receita.getIdFK());
//
//        return removido;
//    }
//
