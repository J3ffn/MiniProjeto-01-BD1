...
public class AtendimentoService {
    ...
    private void verificarIdentificadores(AtendimentoInputDTO atendimentoDeEntrada) {
    ...
    public AtendimentoOutputDTO save(AtendimentoInputDTO atendimentoNovo) {
    ...
    public AtendimentoOutputDTO findById(Integer idAtendimento) {
